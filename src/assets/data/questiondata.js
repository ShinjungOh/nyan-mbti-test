export const QuestionData = [
  ...
  },
  {
    ...
    answera:
      "고양이 관련 커뮤니티에 들어가 다른 집사들과 소통을 하며 고양이에 대한 지식을 쌓는다.",
    answerb:
      "커뮤니티에 가입은 하지만 눈으로 참고만 하고 혼자 찾아본다.",
    type: "EI",
  },
  {
    id: 3,
    ...
    answera:
      "'우리 고양이 너무 이쁜 것 같아.. 사람들한테 자랑해야지!!' 인스타를 만들어서 사진을 공유하고 소통한다.",
  ...
  },
  {
    ...
    answerb: "새롭고 자유로운 방식으로 만들기 위한 방법을 생각한다.",
    type: "SN",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answerb: "'어쩌면 좋아... 속상하겠다...' 일단 먼저 위로를 해준다.",
    type: "TF",
  },
  {
    id: 8,
    title: "고양이를 키우는데 가족과 마찰이 생겼다. 이럴 때 나는?",
    answera:
  ...
  {
    id: 11,
    title: "고양이 사료가 우연히 여러 종류 생겼다. 급여 방법은?",
    answera:
