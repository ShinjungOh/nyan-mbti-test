...
export const ResultData = [
  ...
  },
  {
    ...
    name: '뱅갈',
    best: 'INTP',
    desc: '활동력이 어마어마한 고양이에요! 그렇기 때문에 살이 잘 안찌는 고양이 중에 하나입니다! 집사가 놀아주다가 탈진할 수도!',
    image: `${Bengal}`
  },
  {
    id: 5,
  ...
  },
  {
    ...
    name: '아메리칸 숏헤어',
    best: 'INFP',
    desc: '주인에 대한 호기심이 높고 애교가 굉장히 많아요! 다만! 집사 내꺼야! 독점욕도 굉장히 강합니다. 이미 여러마리의 고양이를 키우는 집사라면 다른 고양이들에게 하악질을 할 수도..',
    image: `${Ameshort}`
  },
  {
    id: 9,
  ...
  },
  {
    ...
    name: '스핑크스',
    best: 'ISTP',
    desc: '유일하게 털이 없는 고양이입니다! 외모와는 다르게 고양이 중에서 가장 성격이 좋다고 하는 고양이계의 골든 리트리버! 다만 피부병이 잘 걸릴 수 있으니 조심조심!',
    image: `${Sphinx}`
  },
  {
    id: 16,
    name: '메인쿤',
    best: 'ENFJ',
    desc: '거인 신사라는 별명을 가진 고양이에요! 조용하고 온화한 성격을 가지고 있으며 매우 똑똑하고 크기와 생김새가 사자나 호랑이처럼 생긴 고양이입니다!',
    image: `${Mainecoon}`
  },
